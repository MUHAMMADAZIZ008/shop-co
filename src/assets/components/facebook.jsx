...
const Facebook = () => {
  return (
    <div className="w-[35px] h-[35px] bg-white border-2 border-gray rounded-full text-primary hover:text-white hover:bg-primary flex items-center justify-center">
      <svg
        width={11}
        height={16}
        viewBox="0 0 8 13"
